...
import fred.util.zip.ZipEntry;
import fred.util.zip.ZipFile;
...
public class JarFile extends ZipFile {
    private static final String TAG = "JarFile";
    ...
    public InputStream getInputStream(ZipEntry ze) throws IOException {
        Log.i(TAG, "get input stream for entry:" + ze.getName() + " verifier:" + verifier);
