...
import fred.nio.charset.ModifiedUtf8;
import fred.util.jar.Attributes;
import fred.util.jar.JarEntry;

import static fred.util.zip.DeflaterOutputStream.BUF_SIZE;
...
public class ZipInputStream extends InflaterInputStream implements ZipConstants {
    ...
    public void closeEntry() throws IOException {
        ...
        if (currentEntry instanceof fred.util.jar.JarEntry) {
    ...
    public int read(byte[] buffer, int start, int length) throws IOException {
        ...
        } catch (Exception/*DataFormatException*/ e) {
